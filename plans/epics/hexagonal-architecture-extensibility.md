...
| Problem | Where | Notes |
|---|---|---|
| **Large canvas adapter** | `SvgCanvasComponent` (~2.4k lines TS) | Overlays + policy modules + keyboard/context-menu unification extracted; hub remains intentional session/lifecycle glue (DEBT-003 ✓). |
