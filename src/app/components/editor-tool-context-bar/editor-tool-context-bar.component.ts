...
import { EllipseToolContextComponent } from '../ellipse-tool-context/ellipse-tool-context.component';

@Component({
  selector: 'app-editor-tool-context-bar',
  imports: [PathNodeAnchorToolsComponent, RectToolContextComponent, EllipseToolContextComponent],
